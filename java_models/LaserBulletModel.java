...
public class LaserBulletModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "laserbulletmodel"), "main");
	private final ModelPart body;
	private final ModelPart outline;

	public LaserBulletModel(ModelPart root) {
		this.body = root.getChild("body");
		this.outline = this.body.getChild("outline");
	}

...
public class FirePeaShooter<T extends FirePeaShooter> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("modid", "firepeashooter"), "main");
	...
	public FirePeaShooter(ModelPart root) {
	...
	@Override
	public void setupAnim(FirePeaShooter entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
